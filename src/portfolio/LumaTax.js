    ...
    return(
        <div className="container">
            <section>
                ...
                <Row>
                    <Col sm={7}>
                    <div className="portfolio__title-context">Context</div>
                    ...
                    <Col sm={5}>
                    <div className="portfolio__title-context">My Roles</div>
                    <ul>
                        <li>Research</li>
                        <li>Ideation</li>
                ...
                <Row>
                    <Col sm={12}>
                        <div className="portfolio__title-sub">Problem Space</div>
                        <div className="portfolio__title">Heavy Government Compliance Costs on Small Business</div>
                        ...
                        <div className="portfolio__image">100</div>
                        <div className="portfolio__image-desc">My initial process was taking the topics from the action plan, mergingn them together then abstracting to potential points of interest.</div>
                        ...
                        <div className="portfolio__title-sub">Get it Shipped</div>
                        <div className="portfolio__title">Doing X</div>
                        <p>They feel that “the decisive factor for the birth of typography”, the use of reusable moulds for casting type, might have been a more progressive process than was previously thought. They suggest that the additional step of using the punch to create a mould that could be reused many times was not taken until twenty years later, in the 1470s. Others have not accepted some or all of their suggestions, and have interpreted the evidence in other ways, and the truth of the matter remains very uncertain.</p>
                        
                        <div className="portfolio__title">Doing Y</div>
                        <p>They feel that “the decisive factor for the birth of typography”, the use of reusable moulds for casting type, might have been a more progressive process than was previously thought. They suggest that the additional step of using the punch to create a mould that could be reused many times was not taken until twenty years later, in the 1470s. Others have not accepted some or all of their suggestions, and have interpreted the evidence in other ways, and the truth of the matter remains very uncertain.</p>
             
                        <div className="portfolio__title-sub">Reflections</div>
                        <div className="portfolio__title">Takeaways</div>
                        <p>They feel that “the decisive factor for the birth of typography”, the use of reusable moulds for casting type, might have been a more progressive process than was previously thought. They suggest that the additional step of using the punch to create a mould that could be reused many times was not taken until twenty years later, in the 1470s. Others have not accepted some or all of their suggestions, and have interpreted the evidence in other ways, and the truth of the matter remains very uncertain.</p>
                    
                        <div className="portfolio__title">Don't do this</div>
                        <p>They feel that “the decisive factor for the birth of typography”, the use of reusable moulds for casting type, might have been a more progressive process than was previously thought. They suggest that the additional step of using the punch to create a mould that could be reused many times was not taken until twenty years later, in the 1470s. Others have not accepted some or all of their suggestions, and have interpreted the evidence in other ways, and the truth of the matter remains very uncertain.</p>
                       
                        <div className="portfolio__title">Learn, Learn, Learn</div>
                        <p>They feel that “the decisive factor for the birth of typography”, the use of reusable moulds for casting type, might have been a more progressive process than was previously thought. They suggest that the additional step of using the punch to create a mould that could be reused many times was not taken until twenty years later, in the 1470s. Others have not accepted some or all of their suggestions, and have interpreted the evidence in other ways, and the truth of the matter remains very uncertain.</p>
                    </Col>
                </Row>
